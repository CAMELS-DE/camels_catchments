...
OUTLETS_CSV = '/output_data/outlets.csv'
...
MERIT_FDIR_DIR = "/input_data/raster/flowdir_basins"

# Directory containing the merged, basin-scale MERIT-Hydro flow accumulation rasters (.tif)
# Download from https://mghydro.com/watersheds/rasters
MERIT_ACCUM_DIR = "/input_data/raster/accum_basins"
...
HIGHRES_CATCHMENTS_DIR = "/input_data/shp/merit_catchments"
...
LOWRES_CATCHMENTS_DIR = "/input_data/shp/catchments_simplified"
